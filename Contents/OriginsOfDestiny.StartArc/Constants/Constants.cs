namespace OriginsOfDestiny.StartArc.Constants;

public static class Constants
{
    public static class Messages
    {
        public static class SimonStart
        {
            public static class Simon
            {
                public static readonly string OneMore = "START_S_ONE_MORE";

                public static readonly string Who = "START_S_WHO";
                public static readonly string How = "START_S_HOW";
                public static readonly string Where = "START_S_WHERE";

                public static readonly string Fool = "START_S_FOOL";
            ...
            {
                public static readonly string Who = "START_M_WHO";
                public static readonly string How = "START_M_HOW";
                public static readonly string Where = "START_M_WHERE";

                public static readonly string Leave = "START_M_LEAVE";

                public static readonly string NotGirl = "START_M_NOTGIRL";
                public static readonly string What = "START_M_WHAT";
            }
